...
//     for (let i = 0; i < arr.length; i++) {
//         let elem = arr[i]
//         if (elem.hobbies.length > max.length) {
//             max = elem.hobbies;
//             x = elem
//         }

//     }
//     console.log(x.hobbies, x.name);
...
//         for (let i = 0; i < arr.length; i++) {
//             let elem = arr[i]
//             if (elem.avgPoint > max) {
//                 max = elem.avgPoint;
//                 x = elem
//             }
    
//         }
//         console.log(x.avgPoint, x.name);
    
//     } hobbi(students)
    

function passwordi(arr) {
    let max = "";
    let x;
    for (let i = 0; i < arr.length; i++) {
        let elem = arr[i]
        if (elem.password.length > max.length) {
            max = elem.passwords;
            x = elem
        }

    }
    console.log(x.password, x.name);
